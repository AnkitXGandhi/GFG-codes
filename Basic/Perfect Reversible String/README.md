<h2><a href="https://www.geeksforgeeks.org/problems/perfect-reversible-string4828/1?page=1&difficulty=Basic&sortBy=submissions">Perfect Reversible String</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:20px">You are given a string ‘str’, the task is to check that reverses of all possible substrings of ‘str’ are present in ‘str’. If yes then the answer is 1, otherwise, the answer will be 0.</span></p>
