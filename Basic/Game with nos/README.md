<h2><a href="https://www.geeksforgeeks.org/problems/game-with-nos3123/1?page=1&difficulty=Basic&sortBy=submissions">Game with nos</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">You are given an array <strong>arr[]</strong>, and you have to re-construct an&nbsp;array <strong>arr[]</strong>.<br>
