<h2><a href="https://www.geeksforgeeks.org/problems/check-perfect-square5253/1?page=1&difficulty=Basic&sortBy=submissions">Check perfect square</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a positive integer N, check if it is a perfect square or not.<br>
