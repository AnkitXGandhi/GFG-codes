<h2><a href="https://www.geeksforgeeks.org/problems/c-strings4609/1?itm_source=geeksforgeeks&itm_medium=article&itm_campaign=practice_card">C++ Strings</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two strings&nbsp; S1 and S2 .&nbsp;You have to concatenate both the strings and print the concatenated string.</span></p>
